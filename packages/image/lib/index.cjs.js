...
function _getImage() {
  _getImage = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3(body, extension) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            console.log(body);
            _context3.next = 7;
            return sharp__default["default"](body).jpeg().toBuffer();
          ...
          case 10:
            return _context3.abrupt("return", new PNG__default["default"](body));
